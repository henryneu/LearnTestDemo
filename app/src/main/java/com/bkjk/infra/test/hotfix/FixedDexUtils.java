 ...
 * Date: 2018/11/9
 * Version: 1.0.0
 * Description:热修复工具(只认后缀是dex、apk、jar、zip的补丁)
 */
//public class FixedDexUtils {
...
//            return;
//        }
//        // 遍历所有的修复dex,将所有的file文件添加到loadedDex
...
//                // 重写给 PathList 里面的 Element[] dexElements; 赋值
...
//
//    /**
//     * 反射得到 pathList 中的 dexElements
//     *
//     * @param pathPathList
//     * @return
//     */
//    private static Object getDexElements(Object pathPathList) throws NoSuchFieldException, IllegalAccessException {
//        return getField(pathPathList, pathPathList.getClass(), "dexElements");
//    }
//
//    /**
//     * 数组合并
...
//     * @return
//     */
//    private static Object combineArray(Object arrayLde, Object arrayRde) {
//        Class<?> componentType = arrayLde.getClass().getComponentType();
//        int i = Array.getLength(arrayLde);  // 获取左数组长度（补丁数组）
//        int j = Array.getLength(arrayRde);  // 获取原 dex 数组长度
//        int k = i + j;                      // 得到总数组长度（不定数组 + 原 dex 数组长度）
//        Object result = Array.newInstance(componentType, k);
//        System.arraycopy(arrayLde, 0, result, 0, i);
//        System.arraycopy(arrayRde, 0, result, 0, j);
//        return result;
//    }
//
//    /**
